...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/ethereum-gas-tracker');
  ...
  return (
    <footer className="mt-24 w-full bg-black">
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex justify-between items-start">
          {/* Left side */}
          <div>
            <div className="text-gray-400 text-xs mb-4 pt-1 pb-1 pl-3 pr-3 bg-gray-900 max-w-[190px]">
              Free open source web3 template
            </div>
            <div className="text-white mb-4 text-2xl font-bold font-sans">
              Build your own ethereum gas tracker
            </div>
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/0xmetaschool/ethereum-gas-tracker/fork"
                target="_blank"
